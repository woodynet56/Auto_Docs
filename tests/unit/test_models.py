...
from app.db.models import AuditEvent, Client, ServiceRequest, WhatsAppMessage
from app.db.models.audit_event import prevent_audit_mutation
from app.db.models.enums import ActorType, IdentifierType, MessageDirection
...
def test_models_use_safe_defaults_and_relationship_ids() -> None:
    client = Client(phone_number="+525500000001")
