...
Versión actual: **0.10.0**. Los documentos permanecen en cuarentena hasta superar
el análisis antimalware. El panel administrativo operativo expone exclusivamente
metadatos sanitizados y requiere un token protegido. El portal exige un código temporal enviado por WhatsApp
antes de mostrar o descargar documentos. El enlace y el código se envían por separado;
este control no se presenta como MFA independiente al utilizar el mismo canal.
